...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key symon telephone-line xcscope wgrep system-packages google-this deadgrep popwin buffer-move auto-complete s magit all-the-icons-dired helm try eyebrowse pdf-tools)))
